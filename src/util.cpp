...
const char * const PIVX_CONF_FILENAME = "modden.conf";
const char * const PIVX_PID_FILENAME = "modden.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";


// Modden only features
// Masternode
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\modden
// Windows >= Vista: C:\Users\Username\AppData\Roaming\modden
// Mac: ~/Library/Application Support/modden
// Unix: ~/.modden
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Modden";
#else
    fs::path pathRet;
...
static fs::path ZC_GetBaseParamsDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\moddenParams
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\moddenParams
    // Mac: ~/Library/Application Support/moddenParams
    // Unix: ~/.modden-params
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ModdenParams";
#else
    fs::path pathRet;
    char* pszHome = getenv("HOME");
    if (pszHome == NULL || strlen(pszHome) == 0)
    ...
    pathRet /= "Library/Application Support";
    TryCreateDirectory(pathRet);
    return pathRet / "ModdenParams";
#else
    // Unix
    return pathRet / ".modden-params";
#endif
#endif
}
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override modden.conf
