...
/** Utility functions used by the Modden Qt UI.
 */
namespace GUIUtil
{
...
// Render MDDN addresses in monospace font
...
// Parse "modden:" URI into recipient object, return true on successful parsing
