...
/* Modden GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Modden"
#define QAPP_ORG_DOMAIN "modden.org"
#define QAPP_APP_NAME_DEFAULT "Modden-Qt"
#define QAPP_APP_NAME_TESTNET "Modden-Qt-testnet"
