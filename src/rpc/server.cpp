...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MDDN features */
        {"modden", "listmasternodes", &listmasternodes, true },
        {"modden", "getmasternodecount", &getmasternodecount, true },
        {"modden", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"modden", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"modden", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"modden", "masternodecurrent", &masternodecurrent, true },
        {"modden", "startmasternode", &startmasternode, true },
        {"modden", "createmasternodekey", &createmasternodekey, true },
        {"modden", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"modden", "listmasternodeconf", &listmasternodeconf, true },
        {"modden", "getmasternodestatus", &getmasternodestatus, true },
        {"modden", "getmasternodewinners", &getmasternodewinners, true },
        {"modden", "getmasternodescores", &getmasternodescores, true },
        {"modden", "preparebudget", &preparebudget, true },
        {"modden", "submitbudget", &submitbudget, true },
        {"modden", "mnbudgetvote", &mnbudgetvote, true },
        {"modden", "getbudgetvotes", &getbudgetvotes, true },
        {"modden", "getnextsuperblock", &getnextsuperblock, true },
        {"modden", "getbudgetprojection", &getbudgetprojection, true },
        {"modden", "getbudgetinfo", &getbudgetinfo, true },
        {"modden", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"modden", "mnfinalbudget", &mnfinalbudget, true },
        {"modden", "checkbudgets", &checkbudgets, true },
        {"modden", "mnsync", &mnsync, true },
        {"modden", "spork", &spork, true },
...
{
    return "> modden-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8669/\n";
}
