...
public:
    CMainParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 12;   
        ...
        consensus.nStakeMinDepthV2 = 36;
        consensus.nTargetTimespan = 30 * 60 * 60;
        ...
        vSeeds.push_back(CDNSSeedData("node", "185.207.104.251"));
        vSeeds.push_back(CDNSSeedData("node", "185.194.141.200"));
        vSeeds.push_back(CDNSSeedData("node", "188.68.42.79"));
        vSeeds.push_back(CDNSSeedData("node", "5.45.107.126"));
        vSeeds.push_back(CDNSSeedData("node", "108.61.156.26"));
        vSeeds.push_back(CDNSSeedData("node", "104.207.133.195"));
        vSeeds.push_back(CDNSSeedData("node", "185.207.105.46"));
        vSeeds.push_back(CDNSSeedData("node", "5.45.99.114"));
