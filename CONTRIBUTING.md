Contributing to Modden Core
============================

The Modden Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ModdenBF/Modden/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Modden Core project, and is not to be
confused with overall Modden Network Protocol consensus changes.

Whether a pull request is merged into Modden Core rests with the project merge
...
Patches that change Modden consensus rules are considerably more involved than
...
Where a patchset proposes to change the Modden consensus, it must have been
...
The project leader is the release manager for each Modden Core release.
