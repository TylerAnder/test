...
#define MyAppName "Modden"
#define MyAppPublisher "2022 Modden developers"
...
OutputDir=.\output
OutputBaseFilename=ModdenSetup
...
[Files]
Source: ".\package\modden-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Modden\Modden-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Modden\Modden-Qt,strDataDir|{userappdata}\Modden\}');
  Result := True;
end;
