...
The script [extract-osx-sdk.sh](https://github.com/ModdenBF/Modden/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ModdenBF/Modden/blob/master/doc/README_osx.md) for troubleshooting tips.